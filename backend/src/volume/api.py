...
class VolumeAPI(object):
    ...
    def create_volume(self,
                      ...
                      guest_uuid: str):
        try:
            data = volume_service.create_volume(pool_uuid, volume_name,
    ...
    def clone_volume(self,
        ...
        try:
            data = volume_service.clone_volume(src_volume_uuid,
                                               dest_pool_uuid,
                                               dest_volume_name)
            return APIResponse.success(data)
        except Exception as e:
    ...
    def delete_volume_by_uuid(self, uuid: str):
        try:
            data = volume_service.delete_volume_by_uuid(uuid)
            return APIResponse.success(data)
        except Exception as e:
            return APIResponse.error(400, e)
    ...
    def get_volume_by_uuid(self, uuid: str):
        try:
            data = volume_service.get_volume_by_uuid(uuid)
            return APIResponse.success(data)
        except Exception as e:
            return APIResponse.error(400, e)
    ...
    def get_volume_by_name(self, pool_uuid: str, volume_name: str):
        try:
            data = volume_service.get_volume_by_name(pool_uuid, volume_name)
            return APIResponse.success(data)
        except Exception as e:
            return APIResponse.error(400, e)
