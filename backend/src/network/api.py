from src.network.service import NetworkService, DockerNetworkService
from src.utils.response import APIResponse
from src.utils.singleton import singleton

network_service = NetworkService()
docker_network_service = DockerNetworkService()
...
@singleton
class DockerNetworkAPI():
    
    def create_top_network(self, network_address: str) -> APIResponse:
        return docker_network_service.create_docker_top_network(network_address=network_address)
    
    def delete_top_network(self) -> APIResponse:
        return docker_network_service.delete_docker_top_network()
    ...
    def delete_interface(self, interface_name: str) -> APIResponse:
        return docker_network_service.delete_docker_interface(interface_name=interface_name)
    
    
    def interface_exists(self, interface_name: str)-> APIResponse:
        return docker_network_service.interface_exists(interface_name=interface_name)
    
    
    def create_network(self, name, network_address) -> APIResponse:
        return docker_network_service.create_docker_network(name=name, ip_address=network_address)
    
    
    def delete_network(self, name) -> APIResponse:
        return docker_network_service.delete_docker_network(network_name=name)
    
    
    def attach_interface_to_container(self, container_uuid: str, interface_name: str)-> APIResponse:
        return docker_network_service.add_interface_to_container(interface_name=interface_name,
                                                                 container_uuid=container_uuid)
    
    def detach_interface_from_container(self, interface_name: str)-> APIResponse:
        return docker_network_service.remove_interface_from_container(interface_name=interface_name)
    
    
        
    def list_networks(self, user_name) -> APIResponse:
        return docker_network_service.list_networks(user_name=user_name)
    
    
    def list_interfaces(self, user_name) -> APIResponse:
        return docker_network_service.list_interfaces(user_name=user_name)
    
    
    def list_container_interfaces(self, container_uuid)-> APIResponse:
        return docker_network_service.list_container_interfaces(container_uuid=container_uuid)
    
    
    def network_detail(self, network_name: str) -> APIResponse:
        return docker_network_service.network_detail(network_name)
    
    
    def interface_detail(self, interface_name: str) -> APIResponse:
        return docker_network_service.interface_detail(interface_name)
    
    

    def get_network_user_uuid(self, network_name) -> APIResponse:
        return docker_network_service.get_network_user_uuid(network_name=network_name)
    
   
    def get_interface_user_uuid(self, interface_name) -> APIResponse:
        return docker_network_service.get_interface_user_uuid(interface_name=interface_name)